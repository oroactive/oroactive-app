const STATIC_CACHE = "oroactive-static-v20260617-academy-no-course-percent-2";
const STATIC_ASSETS = [
  "/index.html",
  "/styles.css?v=20260617-academy-no-course-percent-2",
  "/app.js?v=20260617-academy-no-course-percent-2",
  "/manifest.json",
