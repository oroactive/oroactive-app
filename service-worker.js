const STATIC_CACHE = "oroactive-static-v20260611-course-draft-actions-1";
const STATIC_ASSETS = [
  "/index.html",
  "/styles.css?v=20260611-course-draft-actions-1",
  "/app.js?v=20260611-course-draft-actions-1",
  "/manifest.json",
