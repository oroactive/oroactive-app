const STATIC_CACHE = "oroactive-static-v20260622-complete-buyback-course-1";
const STATIC_ASSETS = [
  "/index.html",
  "/styles.css?v=20260622-complete-buyback-course-1",
  "/app.js?v=20260622-complete-buyback-course-1",
  "/manifest.json",
