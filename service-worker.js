const STATIC_CACHE = "oroactive-static-v20260606-competitor-ai-extract-1";
const STATIC_ASSETS = [
  "/index.html",
  "/styles.css?v=20260606-competitor-ai-extract-1",
  "/app.js?v=20260606-competitor-ai-extract-1",
  "/manifest.json",
