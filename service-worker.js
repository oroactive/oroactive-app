const STATIC_CACHE = "oroactive-static-v20260610-notification-dedicated-row-1";
const STATIC_ASSETS = [
  "/index.html",
  "/styles.css?v=20260610-notification-dedicated-row-1",
  "/app.js?v=20260610-notification-dedicated-row-1",
  "/manifest.json",
