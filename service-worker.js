const STATIC_CACHE = "oroactive-static-v20260529-main-menu-no-sidebar-1";
const STATIC_ASSETS = [
  "/index.html",
  "/styles.css?v=20260529-main-menu-no-sidebar-1",
  "/app.js?v=20260529-main-menu-no-sidebar-1",
  "/manifest.json",
