const STATIC_CACHE = "oroactive-static-v20260615-notification-read-clear-1";
const STATIC_ASSETS = [
  "/index.html",
  "/styles.css?v=20260615-notification-read-clear-1",
  "/app.js?v=20260615-notification-read-clear-1",
  "/manifest.json",
