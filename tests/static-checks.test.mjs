...
test("workflow autorizzazioni blocca pratiche rischiose e traccia Audit Trail", async () => {
  ...
  assert.match(worker, /ducato-austriaco-photos-1/);
});
...
test("qualita generale protegge click doppi messaggi tecnici e caricamenti sezione", async () => {
  ...
  assert.match(index, /app\.js\?v=20260609-ducato-austriaco-photos-1/);
  assert.match(index, /styles\.css\?v=20260609-ducato-austriaco-photos-1/);
  assert.match(worker, /ducato-austriaco-photos-1/);
