...
test("mascotte Aurum interattiva usa gufo dorato, flag e AI esistente", async () => {
  ...
  assert.match(askAurumBlock, /const normativeQuestion = \(!salesQuestion && isAurumNormativeQuestion\(question\)\) \|\| accountingQuestion \|\| professionalGoldQuestion \|\| foundryQuestion/);
