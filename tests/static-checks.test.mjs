...
test("PWA non cachea API e dati sensibili", async () => {
  ...
  assert.match(sw, /\/pdf\//);
  assert.match(sw, /const BUILD_ID = "20260801-aurum-knowledge-os-14"/);
  ...
  assert.match(index, /meta name="oroactive-build-id" content="20260801-aurum-knowledge-os-14"/);
  ...
  assert.match(index, /app\.js\?v=20260801-aurum-knowledge-os-14/);
  assert.match(index, /shared\/aurum-policy\.js\?v=20260801-aurum-knowledge-os-14/);
  assert.match(index, /styles\.css\?v=20260801-aurum-knowledge-os-14/);
  assert.match(version, /"ok": true/);
  assert.match(version, /"assetBuildId": "20260801-aurum-knowledge-os-14"/);
...
test("splash screen iniziale premium animata e senza ghost screen", async () => {
  ...
  assert.match(worker, /20260801-aurum-knowledge-os-14/);
});
...
test("feedback AI passa dalla coda operativa alla Review Queue e si puo eliminare", async () => {
  ...
  assert.match(feedbackToKnowledgeBlock, /INSERT INTO ai_review_queue/);
  assert.match(feedbackToKnowledgeBlock, /SET status = 'in_revisione'/);
  ...
  assert.match(app, /Invia alla Review Queue/);
  assert.match(app, /Feedback anonimizzato inviato alla Review Queue/);
...
test("mascotte Aurum interattiva usa gufo dorato, flag e AI esistente", async () => {
  ...
  assert.match(app, /Fonti utilizzate/);
  assert.match(app, /Mostra fonti e ragionamento operativo/);
  ...
  assert.match(askAurumBlock, /const normativeQuestion = isAurumNormativeQuestion\(question\) \|\| accountingQuestion \|\| professionalGoldQuestion/);
  assert.match(askAurumBlock, /!normativeQuestion && handleAurumTutorRequest\(question\)/);
  assert.match(askAurumBlock, /const professionalResponse = normalizeAurumProfessionalResponse\(data\)/);
  assert.match(askAurumBlock, /content:\s*professionalResponse\.content/);
  assert.match(askAurumBlock, /Non posso verificare in questo momento le fonti approvate e vigenti/);
  assert.doesNotMatch(askAurumBlock, /buildAurumNormativeAnswer\(question\)/);
