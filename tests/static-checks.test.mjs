...
test("PWA non cachea API e dati sensibili", async () => {
  ...
  assert.match(sw, /\/pdf\//);
  assert.match(sw, /const BUILD_ID = "20260730-aurum-sector-knowledge-8"/);
  ...
  assert.match(index, /meta name="oroactive-build-id" content="20260730-aurum-sector-knowledge-8"/);
  ...
  assert.match(index, /app\.js\?v=20260730-aurum-sector-knowledge-8/);
  assert.match(index, /styles\.css\?v=20260730-aurum-sector-knowledge-8/);
  assert.match(version, /"ok": true/);
  assert.match(version, /"assetBuildId": "20260730-aurum-sector-knowledge-8"/);
...
test("splash screen iniziale premium animata e senza ghost screen", async () => {
  ...
  assert.match(worker, /20260730-aurum-sector-knowledge-8/);
});
...
test("mascotte Aurum interattiva usa gufo dorato, flag e AI esistente", async () => {
  ...
  assert.match(server, /Il contenuto non viene trasmesso al modello esterno/);
